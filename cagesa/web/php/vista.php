...
<head>
    ...
    <script type="text/javascript"
        src="<?php echo PAHT_SLIDER_1 ?>js/slider.js"></script>
</head>
<body>
...
<div data-stellar-background-ratio="0.8"
    class="small-12 servicios bgstellar">
    <div class="row">
...
<div id="cliente"
    class="small-12 clientes somos">
    <div class="row">
        <div class="small-12 columns">
            <hr/>
            <h4 class="clientes"><span id="tipClientes"
                    data-tooltip="data-tooltip"
                    aria-haspopup="true"

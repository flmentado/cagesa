...
<div class="row">
    ...
    <div id="servicios" class="small-12 columns small-centered" data-magellan-destination="servicios">
        <ul class="small-block-grid-1 large-block-grid-3 pagination-centered">
            <li class="servicios">
                <div class="iconMantenimiento"></div>
                <h2>Mantenimiento</h2>

                <p class="descripcion"> Tenemos el servicio que se ajusta a sus necesidades. Somos flexibles y nos
                    adaptamos al tamaño de su jardín. No importa si es un jardín unifamiliar, comunidad o empresa. </p>
            </li>
            <li class="servicios">
                <div class="iconAsesoramiento"></div>
                <h2>Asesoramiento</h2>

                <p class="descripcion"> Le aconsejaremos sobre las plantas, materiales, terreno, drenajes y riego para
                    que su jardín sea ese espacio que haga que usted se encuentre orgulloso y satisfecho. </p>
            </li>
            <li class="servicios">
                <div class="iconInstalaciones"></div>
                <h2>Instalaciones</h2>

                <p class="descripcion"> Para aquellos clientes que ya disponen de servicios propios de jardinería. Les
                    ofrecemos esta labor que les permitirá sentirse dueños de su jardín. </p>
            </li>
        </ul>
    </div>
</div>
<!-- Lema de la empresa -->
<div class="small-12 lema2">
    <h1 class="text-center">Lorem ipsum dolor sit amet. <a class="myButton " href="">Contactar</a></h1>

</div>
<br>
<!--Clientes de la empresa-->
<div class="row">
    <div id="clientes" class="small-12 columns" data-magellan-destination="clientes">
        <div class="small-12 medium-2 large-2 columns">
            <p>Aqui hay una pequeña muestra de nuestros trabajos realizados, nuestros profesionales sacan el mejor
                resultado de sus jardines</p>
        </div>
           ...
           <div class="row">
            ...
            <div class="row">
                <div class="small-12 medium-12 large-12 columns">
                    ...
                    <ul class="small-block-grid-1 large-block-grid-3 pagination-centered">
                        <li>
                            <div class="redesF"></div>
                        </li>
                        <li>
                            <div class="redesT"></div>
                        </li>
                        <li>
                            <div class="redesI"></div>
                        </li>
                    </ul>
                    <hr>
                </div>

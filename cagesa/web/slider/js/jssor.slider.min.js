(function (f, e, b, g, c, d, h) {/*! Jssor */
    ...
    var k = f.$JssorEasing$ = {
        ...
        var i = this, L = /\S+/g, lb = 1, F = 2, F = 3, eb = 4, ib = 5, q = 0, l = 0, t = 0, X = 0, D = 0, qb = navigator.appName, k = navigator.userAgent, p = e.documentElement, B;
        ...
        function W(e, a) {
            ...
            if (A()) {
                ...
                if (j) {
                    ...
                    if (cb() && D > 535 && "ontouchstart"in f)k += " perspective(2000px)";
                    e.style[j] = k
                }
            }
        }
        ...
        i.$SetStyleTransform = function (b, a) {
            if (Y())pb(i.$CreateCallback(g, W, b, a)); else W(b, a)
        };
        ...
        i.$WindowResizeFilter = function (b, a) {
            return A() ? function () {
                ...
                if (e) {
                    var g = e.offsetWidth - gb, f = e.offsetHeight - bb;
                    if (g || f) {
                        gb += g;
                        bb += f
                    } else h = d
    ...
    new function () {
        ...
        function m(q, lc) {
            ...
            function Ec(p, n) {
                ...
                function ab(b) {
                    if (b == Y && s == n) {
                        if (!h) {
                            ...
                            Z();
                            h = new Cc(n, a, e.$GetCaptionSliderIn(), e.$GetCaptionSliderOut());
                            h.$SetPlayer(k)
                        }
                ...
                function R(b, e, d) {
                    ...
                    a.$Each(g, function (g) {
                        ...
                        if (i == "player" && !w) {
                            w = g;
                            if (w.pInstance)M(); else a.$AddEvent(w, "dataavailable", M)
                        }
                        if (i == "caption") {
                            if (!a.$IsBrowserIE() && !e) {
                                var h = a.$CloneNode(g);
            ...
            function Cc(h, q, v, u) {
                ...
                b.$Replay = function () {
                    ...
                    if (!C && !S && !t && s == h) {
                        ...
                        var i = T && (!J || G);
                        if (a == f)(e != f && !(J & 12) || i) && p.$GoForNextSlide(); else(i || a != e) && b.$PlayToPosition(d, z)
                    }
                };
            ...
            var o = a.$Extend({
                ...
                $PlayOrientation: 1,
                $DragOrientation: 1
            }, lc), nb = o.$PlayOrientation & 3, bc = (o.$PlayOrientation & 4) / -4 || 1, cb = o.$SlideshowOptions, I = a.$Extend({
                $Class: r,
                $PlayInMode: 1,
                $PlayOutMode: 1
    ...
    f.$JssorBulletNavigator$ = function (f, F, E, C) {
        ...
        l.call(h);
        f = a.$GetElement(f);
        var t, u, s, r, m = 0, e, o, k, y, z, j, i, q, p, D = [], A = [];
        ...
        h.$Options = e = a.$Extend({$SpacingX: 0, $SpacingY: 0, $Orientation: 1, $ActionMode: 1}, F);
    ...
    f.$JssorArrowNavigator$ = function (e, f, t, o, m) {
        var b = this;
        l.call(b);
        var i, h, j, r = a.$CssWidth(e), p = a.$CssHeight(e);
        ...
        b.$Options = h = a.$Extend({$Steps: 1}, t);
        j = h.$Steps
    };
